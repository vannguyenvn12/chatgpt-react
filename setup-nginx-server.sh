...
# 🚀 Setup Nginx Server for chat.icahg.com
# Script này sẽ cấu hình nginx server để proxy đến Docker container
...
print_header() {
    echo -e "${PURPLE}========================================${NC}"
    echo -e "${PURPLE}🚀 Setup Nginx Server - chat.icahg.com${NC}"
    echo -e "${PURPLE}========================================${NC}"
}
...
print_success "🎉 NGINX SERVER SETUP COMPLETED!"
echo
...
echo
print_success "🚀 Your nginx server is ready to proxy to Docker container!"
