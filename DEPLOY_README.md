# 🚀 ChatGPT React Frontend - Docker Deploy với SSL

## 📋 Tổng quan

Đây là hướng dẫn deploy ứng dụng React ChatGPT frontend sử dụng Docker với HTTPS, kết nối với API external tại `https://api-ai.vannguyenv12.com/`.
...
├── deploy.sh               # Deploy script (HTTP)
├── deploy-ssl.sh           # Deploy script với SSL
