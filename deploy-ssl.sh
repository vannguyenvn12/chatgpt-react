...
# 🚀 Deploy Frontend React với SSL - chat.icahg.com
# Script này sẽ deploy React frontend với HTTPS cho domain chat.icahg.com
...
print_header() {
    echo -e "${PURPLE}========================================${NC}"
    echo -e "${PURPLE}🚀 Deploy React với SSL - chat.icahg.com${NC}"
    echo -e "${PURPLE}========================================${NC}"
}
